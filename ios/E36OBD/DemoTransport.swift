...
enum DemoScenario: String, CaseIterable, Identifiable {
    case normal = "Ralentí", cut = "Carga baja", heat = "Temperatura", off = "Motor apagado", saturated = "Saturación", disconnect = "Desconexión"
...
@MainActor final class DemoTransport: ReaderTransport {
    ...
    func write(_ command: Command) {
        ...
        case .live:
            ...
            send("abriendo sesion..."); send("en vivo. cualquier tecla corta.")
        ...
        case .help:
            if faultsOpen {
                ...
                send("cod 36  ocurr 50"); send("  cond 0x72"); faultsOpen = false
            }
